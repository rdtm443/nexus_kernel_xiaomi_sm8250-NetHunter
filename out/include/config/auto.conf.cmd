...
ifneq "$(KERNELVERSION)" "4.19.267"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "Android (9146769, based on r468909b) clang version 15.0.3 (https://android.googlesource.com/toolchain/llvm-project 617109052e5bd421c75c61561ed3c3cbc28abe33)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/home/rdtm443/nexus_kernel_xiaomi_sm8250-NetHunter/gcc/bin/aarch64-linux-android- --gcc-toolchain=/home/rdtm443/nexus_kernel_xiaomi_sm8250-NetHunter/gcc  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
endif
ifneq "$(CROSS_COMPILE_COMPAT)" "arm-linux-androideabi-"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "clang++"
include/config/auto.conf: FORCE
